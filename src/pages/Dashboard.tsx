  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-6">
        <Link
          to="/settings"
          className="font-inter font-medium transition-colors duration-300 hover:text-white"
        ...
        <Link
          to="/"
          className="font-inter font-medium transition-all duration-300 hover:underline"
          style={{ fontSize: 14, color: '#E6EDE8' }}
        >
          Naar check-in{' '}
