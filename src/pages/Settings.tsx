...
function isValidDutchPhone(phone: string): boolean {
...
export default function Settings() {
  ...
  const handlePhoneBlur = () => {
    if (phone && !isValidDutchPhone(phone)) {
      setPhoneError('Voer een geldig telefoonnummer in.');
    } else {
      setPhoneError('');
    }
  };
  ...
  return (
    <div
      className="font-inter min-h-[100dvh] w-full"
    ...
    >
      ...
      <div className="mx-auto px-6 pb-12" style={{ maxWidth: 800 }}>
          ...
          >
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                >
                  Configureer wie een melding ontvangt bij een rode
                  registratie.
                </p>
              </div>
            </div>
            ...
            <div className="mb-6">
              ...
              <Textarea
                placeholder="🚨 EmotieCheck dagbesteding — Een deelnemer heeft aangegeven zich niet goed te voelen om {tijd}. Controleer alsjeblieft."
                value={template}
        ...
        <div className="mt-10 flex justify-center pb-8">
          <button
            onClick={() => navigate('/dashboard')}
            className="flex items-center gap-2 font-inter transition-colors duration-200 focus:outline-none"
            style={{
              fontSize: 13,
              color: 'rgba(255,255,255,0.4)',
              background: 'none',
